...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    callback_api_1.default.connect('amqps://pvcbecxw:fKZHk7qwm-kZsa-6KQDAZS-U7UUSq7FO@hornet.rmq.cloudamqp.com/pvcbecxw', function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume('product_created', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, product, error_1;
